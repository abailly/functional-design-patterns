...
import glsi.inter.ISaver;
import glsi.inter.ISimulation;


/**
 * La classe Main permet d'executer l'application. Elle offre un menu a l'utilisateur lui proposant diff�rents choix:
 *
 * <ul>
 * <li>Effectuer une simulation au moyen de fichiers : un fichier en entree et un fichier en sortie.</li>
 * <li>Effectuer une simulation grace a la ligne de commande. Dans ce cas, l'utilisateur doit saisir l'ensemble des
 * informations au fur et a mesure en utilisant les commandes mis a se disposition (voir plus loin).</li>
 * <li>Quitter l'application</li>
 * </ul>
 *
 * Pour l'interface en ligne de commande, l'utilisateur doit utiliser les commandes suivantes :
 *
 * <ul>
 ...
 * <li>envoieInitNoeud pour envoyer l'initialisation lorsque tous les noeuds ont �t� saisie.</li>
...
public class Main {
     ...
     */
    public Main() throws LoaderException, SimulationException, FileNotFoundException {
    ...
    public static void main(String[] args) throws LoaderException, SimulationException, FileNotFoundException {
        new Main();
    }
    ...
    public void helpCmde() {
        ...
        System.out.println("\tinitRobot abscisse;ordonn�e;orientation;batterie");
        ...
        System.out.println("DESCRIPTION");
        System.out.println("\tL'ensemble des commandes permettent de g�rer la simulation.");
        System.out.println("\tLa commande 'initPlateau' permet de cr�er et d'initialiser un plateau. Pour ce faire," +
            "il faut fournir en parametre l'abscisse et l'ordonn�e de la facon suivante : abscisse;ordonn�e.");
        System.out.println("\tLa commande 'initBase' permet de positionner la base sur le terrain." +
        ...
        System.out.println("\tLa commande 'initNoeud' permet d'initialiser un noeud sur du terrain. Il faut respecter le " +
            ...
            " 1 sinon.");
        System.out.println("\tUne fois que tous les noeuds sont initialis�s, on les prends en compte pour la simulation" +
            "grace � la commande 'envoieInitNoeud'");
        System.out.println("\tPour pouvoir cr�er un robot, il faut utiliser la commande 'initRobot'" +
        ...
        System.out.println("\tPour donner un ordre � un robot, il faut utiliser la commande 'ordre' avec le formalisme suivant" +
        ...
        System.out.println("\tPour sauver la simulation, il faut utiliser la commande 'save'");
        System.out.println("\tPour charger un fichier, utilisez la commande 'load'");
        System.out.println("\t'afficherSimulation' permet d'afficher la simulation.");
        System.out.println("\tPour afficher l'aide, employez la commande 'help'");
        System.out.println("\tPour terminer la session en ligne de commande, utilisez la commande 'exit'");
        System.out.println("");
     ...
     * @throws FileNotFoundException
     */
    private void menu() throws LoaderException, SimulationException, FileNotFoundException {
        int choix = 0;
    ...
    /**
     * Ensemble des commandes permettant le lancement et le deroulement d'une simulation au moyen de fichiers.
     *
     * @throws FileNotFoundException
     */
    private void gestionFichier() throws LoaderException, SimulationException, FileNotFoundException {
    ...
    /**
     * Ensemble des commandes permettant le lancement et le deroulement d'une simulation en ligne de commandes
     *
     * @throws FileNotFoundException
     */
    private void gestionLigneCmd() throws LoaderException, SimulationException, FileNotFoundException {
                            ...
                            if (tmp[0].equals("envoieInitNoeud")) { // envoie
                                ...
                                if (tmp[0].equals("initRobot")) { // creation
                                    ...
                                    if (tmp[0].equals("ordre")) { // sequence
                                                                  // d'ordre
                                        tmp = tmp[1].split(";");
                                        String[] action = new String[] { tmp[0], tmp[1] };
                                        ...
                                        if (tmp[0].equals("save")) {
                                            ...
                                            if (tmp[0].equals("help")) {
                                                ...
                                                if (tmp[0].equals("load")) {
                                                    ...
                                                    if (tmp[0].equals("afficherSimulation")) {
                                                        try {
                                                            System.out.println("\n" +
                                                                s);
                                                        } catch (NullPointerException e) {
                                                            throw new SimulationException("La simulation n'est pas initialis�e.");
                                                        }
                                                    } else {
                                                        this.helpCmde();
                                                    }
